...
#set up some info
sheetkey="1jCqHhnn5I_f-c3R3M_f-szqok2H5Zs7SvSn2U8zrtvU"
sheetfull="https://docs.google.com/spreadsheet/ccc?key=" + sheetkey   #use this to see the actual sheet
sheetresults = "#gid=533959428"                 #append this to the URL for the sheet this program will use (pubmed_result)
...
# :first_in sets how long it takes before the job is first run. In this case, it is run immediately
	...
	send_event('homevisits', { value:s.cell('I',10) })
