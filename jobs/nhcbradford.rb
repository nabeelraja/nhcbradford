...
# Constants
SERVICE_ACCOUNT_EMAIL_ADDRESS = '62012074485-0l0qf2ch30iajdlt54arfnjopsmiglkn@developer.gserviceaccount.com' # Email of service account
KEY_FILE              = 'client.p12' # File containing your private key
SECRET                        = 'notasecret' # Password to unlock private key
GOOGLE_SHEET_KEY			  = '1jCqHhnn5I_f-c3R3M_f-szqok2H5Zs7SvSn2U8zrtvU' # Google spreadsheet Key
...
:application_name => 'NHC Bradford Dashboard',
